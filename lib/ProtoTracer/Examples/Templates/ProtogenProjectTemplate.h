...
private:
    ...
    SimpleMaterial purpleMaterial = SimpleMaterial(RGBColor(130, 0, 255)); ///< Solid purple material.
    SimpleMaterial blackMaterial  = SimpleMaterial(RGBColor(0, 0, 0));     ///< Solid black material.
    SimpleMaterial roseMaterial = SimpleMaterial(RGBColor(255, 150, 255)); ///< Solid rose material.
    SimpleMaterial customMaterial = SimpleMaterial(RGBColor(100, 100, 100)); ///< Custom color material.
